...
-- Ensure mise shims are in PATH (needed when Neovim is launched outside of a shell)
...
-- nvim-treesitter (main branch) installs parsers here; must be in rtp
          ...
          settings = {
            ...
            typescript = {
              ...
              inlayHints = {
                ...
                variableTypes = { enabled = false }, -- 너무 노이지할 수 있어서 기본 off
